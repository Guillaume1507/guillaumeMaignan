import picturedogg1 from "../picture/home_doggies-removebg-preview.png";
import picturedogg2 from "../picture/landing-removebg-preview.png";
import picturedogg3 from "../picture/doginfos3_preview_rev_1.png";
import picturedogg4 from "../picture/mapdoggies-removebg-preview-removebg-preview.png";
...
function DoggiesApp(props) {
  ...
  var imgStyle3 = {
    transform: `translate(0px,-${scrollPercentAdjust * 3}%) scale(0.6)`,
  };
  var imgStyle4 = {
    transform: `translate(0px,-${scrollPercentAdjust * 4}%) scale(0.7) `,
  };
